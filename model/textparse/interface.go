...
type ParserOptions struct {
	// ParseClassicHistograms causes the parser to parse classic histograms.
	ParseClassicHistograms bool

	// ConvertClassicHistogramsToNHCB causes the parser to convert parsed classic histograms.
	// to native histograms.
	ConvertClassicHistogramsToNHCB bool

	// SkipOMCTSeries causes the OpenMetrics parser to skip parsing of exemplars.
	SkipOMCTSeries bool

	// EnableTypeAndUnitLabels causes the parser to parse type and unit labels.
