...
type Appender interface {
	...
	AppendSummary(t int64, st int64, s *summary.Summary) (c Chunk, app Appender, err error)
}
...
const (
	...
	ValSummary                         // A summary, retrieved with AtSummary.
)
...
func (it *mockSeriesIterator) AtSummary(*summary.Summary) (int64, *summary.Summary) {
	panic("exp: calling AtSummary on mockSeriesIterator is not supported")
}
...
func (nopIterator) AtSummary(*summary.Summary) (int64, *summary.Summary) {
	panic("exp: calling AtSummary on nopIterator is not supported")
}
